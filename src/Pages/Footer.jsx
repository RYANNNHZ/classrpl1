					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						<div className=" ">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/driiiiiaaaaaannnnnnnn/" class="hover:underline">
										DRIANNN
									</a>
								</li>
								<li>
									<a href="https://www.instagram.com/projek_jn/?utm_source=ig_web_button_share_sheet&igshid=OGQ5ZDc2ODk2ZA==" class="hover:underline">
										JYANNN
									</a>
								</li>
							</ul>
						...
						<div className="">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/zopsat.1/?utm_source=ig_web_button_share_sheet&igshid=OGQ5ZDc2ODk2ZA==" class="hover:underline ">
										Instagram
									</a>
								</li>
							</ul>
